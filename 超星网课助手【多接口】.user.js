...
// @namespace    MCDream
// @version      4.0.5.1
// @description  【无需token】自动挂机看尔雅MOOC，支持视频、音频、文档、图书自动完成，章节测验自动答题提交，支持自动切换任务点、挂机阅读时长、自动登录等，解除各类功能限制，开放自定义参数。集成各个作者大大的接口，便捷切换
...
var setting = {
        ...
        ,rate: '6' // 视频播放默认倍率，参数范围0∪[0.0625,16]，'0'为秒过，默认'1'倍
